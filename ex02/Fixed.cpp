...
Fixed Fixed::operator*(const Fixed& rhs) const {
	Fixed result;
	result.setRawBits((static_cast<long>(getRawBits()) * rhs.getRawBits()) >> this->_fractionalBits);
	return result;
}

Fixed Fixed::operator/(const Fixed& rhs) const {
	Fixed result;
	result.setRawBits((static_cast<long>(getRawBits()) << this->_fractionalBits) / rhs.getRawBits());
	return result;
}
